...
export default {
    ...
    methods: {
        ...
        gatherStats() {
            ...
            this.girlsDead = stats_disease[0].age_at_first_symp.girls.array.filter((val) => val == 1).length
            this.boysDead = stats_disease[0].age_at_first_symp.boys.array.filter((val) => val == 1).length
