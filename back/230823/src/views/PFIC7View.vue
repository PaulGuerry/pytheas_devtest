<template lang="html">
    <div class="w-full grid grid-cols-1 place-items-center my-10 mx-auto">
        ...
        <p  class="text-xl  text-gray-400 my-10"> PFIC7 </p>
        ...
        <MySymptoms :gene="gene" :disease="PFIC7" :branchLevel="branchLevel" :key="branchLevel+girlNo" @patient-counts="updatePatientNo"/>
