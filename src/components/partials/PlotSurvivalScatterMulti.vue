    ...
    methods: {
        ...
        gatherStats() {
            ...
            for (var gene of this.propData.genes) {
                ...
                stats_el.patientTotal = stats_disease[0].age_at_last_news.all.array.length 
                ...
                survival_el.x = stats_disease[0].age_at_last_news.all.surv_x
                survival_el.y = stats_disease[0].age_at_last_news.all.surv_y
