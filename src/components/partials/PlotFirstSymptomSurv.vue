...
export default {
    ...
    methods: {
        ...
        gatherStats(...Args) {
            ...
            let i = 0
            for (var sel of Args) {
                let survival_el = {x:[], y:[], name: "", median: 0, iqr: 0, type: "scatter", mode: "lines", line: {width: 2, color: this.colors[i], shape: "hv"}}
                let stats_sel = stats_disease[0].age_at_first_symp[sel]
