    ...
    methods: {
        initialState() {
            return {
                ...
                isPFIC11: false, isCDG2P: false, isTHES1: false, isTHES2: false, isFOCAD: false,
        ...
        falsify() {
            ...
            this.isPFIC11 = false, this.isCDG2P = false, this.isTHES1 = false, this.isTHES2 = false, this.isFOCAD = false
